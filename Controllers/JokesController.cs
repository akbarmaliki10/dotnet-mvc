...
namespace WebApplication1.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Question,QuestionAnswer")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Question,QuestionAnswer")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
